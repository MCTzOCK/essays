...
\begin{document}
    ...
    Hierdurch lassen sich die Laufzeit und die damit einhergehende Effizienz der Algorithmen anschaulich vergleichen.
    Die Grafiken zeigen alle in der obigen Tabelle (siehe Tabelle \ref{tab:runtimeanalysis}) aufgeführten Laufzeiten.
    So lässt sich direkt erkennen, dass der QuickSort-Algorithmus im Durchschnitt eine deutlich geringere Laufzeit hat,
    als die anderen drei Algorithmen, da er insgesamt weniger Vergleiche benötigt:
    \begin{multicols}{3}
