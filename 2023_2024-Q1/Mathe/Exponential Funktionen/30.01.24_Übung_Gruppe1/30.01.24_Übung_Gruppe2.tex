...
\begin{document}
	...
	\\
	$
	e^{2x - 7} \times (8 + 8x) = 0 \ \ \ \ \ \ \ e^{2x^7} \ne 0 \forall \in \rm I\!R \\
	8 + 8x = 0\ \Bigl|-8 \\
	8x = -8\ \Bigl|\div 8 \\
	x = -1
	$ \\
	hinreichende Bedingung für WST: $f''(x) = 0 \land f'''(x) \ne 0$ \\
	$f'''(-1) = e^{2 \times (-1) - 7} \times (23 + 16 \times (-1)) \\
	= e^{-9} \times 7 > 0 \to links-rechts\ Kurve$ \\
	\textbf{Monotinie:}
	\\
	Monoton fallend bis $x = -\frac{1}{2}$; danach monoton steigend, weil $TP(\frac{1}{2}\Bigl|-e^{-8})$
